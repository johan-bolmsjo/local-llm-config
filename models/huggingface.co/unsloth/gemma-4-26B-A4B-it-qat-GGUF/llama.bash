...
#
# Model: Gemma-4-26B-A4B (4-bit QAT quant, 256k context window)
#
llama_run_model() {
    ...
    # Regular model
    local -a ARGS=(--model "$LLM_MODEL_DIR/gemma-4-26B-A4B-it-qat-UD-Q4_K_XL.gguf")

    # Draft model (MTP)
    ARGS+=(--model-draft "$LLM_MODEL_DIR/mtp-gemma-4-26B-A4B-it.gguf")
