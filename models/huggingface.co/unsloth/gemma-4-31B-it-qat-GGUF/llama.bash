...
#
# Model: Gemma-4-31B (4-bit QAT quant, 128k context window)
#
llama_run_model() {
    ...
    # Regular model
    local -a ARGS=(--model "$LLM_MODEL_DIR/gemma-4-31B-it-qat-UD-Q4_K_XL.gguf")

    # Draft model (MTP)
    ARGS+=(--model-draft "$LLM_MODEL_DIR/mtp-gemma-4-31B-it.gguf")
    ...
    ARGS+=(--cache-ram 4096 --ctx-checkpoints 16 --batch-size 1024 --ubatch-size 1024)
